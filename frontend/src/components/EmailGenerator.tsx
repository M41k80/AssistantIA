...
const EmailGenerator = () => {
    ...
    return (
        <div className="min-h-screen bg-oscuro text-azul p-8 rounded-xl shadow-2xl max-w-3xl mx-auto mt-10">
            <h2 className="text-4xl font-bold mb-6 text-azul text-center">Generador de Emails con IA</h2>
            <div className="grid grid-cols-1 gap-4">
                <input
                    type="text"
                    className="bg-claro border border-gray-700 p-2 rounded text-oscuro"
                ...
                <button
                    ...
                    className="bg-blue-500 hover:bg-blue-700 transition-colors text-claro py-2 px-4 rounded"
                    disabled={loading}
                >
            ...
            {resultado?.email && (
                <div className="mt-10 bg-claro p-6 rounded shadow-md">
                    {/* <h2 className="text-xl font-semibold text-blue-600 mb-2">Resultado</h2> */}

                    <p className="text-blue-500 mb-1 font-bold">Asunto:</p>
                    <p className="text-oscuro mb-4">{resultado.email.subject}</p>

                    <p className="text-blue-500 mb-1 font-bold">Vista previa:</p>
                    <p className="text-oscuro mb-4">{resultado.email.preview}</p>

                    <p className="text-blue-500 mb-1 font-bold">Cuerpo del Email:</p>
                    <div
                        className="text-oscuro prose prose-invert max-w-none"
                        dangerouslySetInnerHTML={{ __html: resultado.email.body }}
                    />

                    <p className="mt-4 text-blue-500 mb-1 font-bold">Llamado a la acción (CTA):</p>
                    <p className="text-oscuro mb-4">{resultado.email.cta}</p>
            ...
            {resultado?.image && (
                <div className="mt-10">
                    <h3 className="text-xl font-semibold text-blue-500 mb-2">Imagen generada</h3>
